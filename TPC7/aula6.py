...
db_file = open("/home/gil/Minho/4º ano/PLN/aulas/aula_7/conceitos_.json")
...
def delete_conceito(designacao):
    ...
    return {"sucess":False,"message":"O conceito não existe","data":designacao}

@app.get("/conceitos/tabela")
def conceitos_tabela():
    return render_template("tabela.html", db)
